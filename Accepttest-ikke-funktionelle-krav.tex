...
\begin{longtable}{ p{2cm}  p{2cm}  p{2cm}  p{1.5cm} p{2cm} }
   ...
   \endhead
    ...
    GUI skal have en reaktionstid på MAX. 1 sekund. & Der trykkes på GUIs virtuelle knapper og tages tid med stopur. & Der går max 1. sekund fra tryk til opdatering af det grafiske layout. & &\\
